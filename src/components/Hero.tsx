  ...
  return (
    ...
    >
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute bottom-1/4 right-1/4 w-96 h-96 rounded-full bg-blue-100/40 filter blur-3xl animate-float" style={{ animationDelay: "1s" }}></div>
        <div className="absolute top-1/3 right-1/3 w-64 h-64 rounded-full bg-yellow-100/40 filter blur-3xl animate-float" style={{ animationDelay: "2s" }}></div>
      </div>
      ...
      <div className="glass-panel max-w-5xl mx-auto p-12 md:p-16 relative z-10 stagger-animate opacity-0 translate-y-10 transition-all duration-1000">
        <div className="text-center">
          ...
          <p className="text-xl md:text-2xl text-soft-black/80 max-w-3xl mx-auto mb-10 animate-fade-in" style={{ animationDelay: "0.5s" }}>
            Creative video editor crafting stunning visual narratives with precision and artistic flair
          </p>
