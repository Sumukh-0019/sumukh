...
const Hero = () => {
  ...
  return (
    ...
    >
      ...
      <div className="scroll-animate-scale glass-panel max-w-5xl mx-auto p-12 md:p-16 relative z-10">
        <div className="text-center">
          <h1 ref={titleRef} className="hero-title mb-6">
            Sumukh's Portfolio
          </h1>
          <p className="scroll-animate-fast text-xl md:text-2xl text-soft-black/80 max-w-3xl mx-auto mb-10 font-semibold">
            EDITOR MORE THAN AN AVERAGE, LESS THAN A PRO, BUT JUST PERFECT FOR YOU :)
          </p>
          
          <a 
            href="#tools" 
            className="scroll-animate-fast inline-flex items-center gap-2 bg-soft-black text-beige px-6 py-3 rounded-full font-medium transition-all duration-300 hover:shadow-lg hover:-translate-y-1"
          >
            Explore My Work
